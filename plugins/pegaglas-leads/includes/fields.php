...
function npl_choices() {
	return apply_filters(
		...
		array(
			'service'  => array(
				'replacement' => __( 'Lägga om hela taket', 'pegaglas-leads' ),
				'storm'       => __( 'Storm or hail damage', 'pegaglas-leads' ),
				'repair'      => __( 'Läcka eller reparation', 'pegaglas-leads' ),
				'inspection'  => __( 'Bara en besiktning', 'pegaglas-leads' ),
				'not-sure'    => __( 'Vet inte än', 'pegaglas-leads' ),
			),
			'timeline' => array(
				'asap'     => __( 'Så snart som möjligt', 'pegaglas-leads' ),
				'1-3'      => __( 'Inom 1–3 månader', 'pegaglas-leads' ),
				'research' => __( 'Jag kollar bara priser', 'pegaglas-leads' ),
			),
		)
	);
}
...
function npl_consent_text() {
	return apply_filters(
		'npl_consent_text',
		__( 'Genom att skicka förfrågan godkänner du att vi kontaktar dig om ditt tak. Vi sparar uppgifterna bara för det, lämnar dem aldrig vidare, och du kan när som helst be oss radera dem.', 'pegaglas-leads' )
	);
}
...
function npl_statuses() {
	return array(
		'new'       => __( 'New', 'pegaglas-leads' ),
		'contacted' => __( 'Kontaktad', 'pegaglas-leads' ),
		'quoted'    => __( 'Quote sent', 'pegaglas-leads' ),
		'won'       => __( 'Won', 'pegaglas-leads' ),
		'lost'      => __( 'Lost', 'pegaglas-leads' ),
		'spam'      => __( 'Misstänkt spam', 'pegaglas-leads' ),
	);
}
